...
public class AddMedcine extends AppCompatActivity implements TimeDoseDialge.AlarmDose_value {
    ...
    EditText MedName ,MedNote;
    ImageButton Imdrop;
    Spinner Sp_DayTime;
    int NoTime=1,Dose;
   TextView FirstAlarma,startDate,SecondAlarm,ThirdAlarm ,MedMember,Med_FDose,Med_SDose,Med_ThDose;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirstAlarma =(TextView)findViewById(R.id.ed_FirstAlarm);
        SecondAlarm= (TextView)findViewById(R.id.ed_secondAlarm);
        ThirdAlarm =  (TextView)findViewById(R.id.ed_thirdAlarm);
        ...
        Med_SDose =(TextView)findViewById(R.id.ed_SecondeDose);
        Med_FDose =(TextView)findViewById(R.id.ed_Dose);
        Med_ThDose =(TextView)findViewById(R.id.ed_ThirdDose);

        Sp_DayTime =(Spinner)findViewById(R.id.Sp_DayTime);
        db = new Mysql(getBaseContext());

        if(med_Id == 0) {
            FirstAlarma.setText(new SimpleDateFormat("hh:mm a").format(Calendar.getInstance().getTime()).toString());
            SecondAlarm.setText(new SimpleDateFormat("hh:mm a").format(Calendar.getInstance().getTime()).toString());
            ThirdAlarm.setText(new SimpleDateFormat("hh:mm a").format(Calendar.getInstance().getTime()).toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.addmed)
        {
           ...
           First_Alarm = FirstAlarma.getText().toString();
            ...
            if(Med_Note != null && Med_name != null && First_Alarm != null && start_Date != null )
            {
                try {

                    if(med_Id == 0) {
                        Date startdate= new SimpleDateFormat("mm/dd/yy", Locale.getDefault()).parse(start_Date);
                        Date _firstAlarm= new SimpleDateFormat("hh:mm a", Locale.getDefault()).parse(First_Alarm);
                        ...
                        Date startdate= (Date)new SimpleDateFormat("MM/dd", Locale.getDefault()).parse(start_Date);
                        Date _firstAlarm=(Date) new SimpleDateFormat("hh:mm a").parse(First_Alarm);
            ...
            {
                Toast.makeText(getBaseContext(),getResources().getString(R.string.ENTerData).toString(),Toast.LENGTH_LONG).show();
            }
